            ...
            <div className="mx-auto max-w-screen-xl px-4 py-6 lg:py-8">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center text-center">
                    ...
                    <div className="flex justify-center space-x-5">
                        <a href="https://www.linkedin.com/in/lex-renders/" target="_blank" rel="noopener noreferrer" className="text-gray-100 hover:text-gray-900 dark:hover:text-purple-500">
                        ...
                        <a href="https://github.com/LexRenders" target="_blank" rel="noopener noreferrer" className="text-gray-100 hover:text-gray-900 dark:hover:text-purple-500">
                            <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 496 512" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="text-center">
                    <span className="text-sm text-gray-50 dark:text-gray-50">
                        © 2025 <a href="/" className="hover:underline">Lex Renders</a>. All Rights Reserved.
                    </span>
                </div>
            </div>
        </footer>
