            ...
            <div className="mx-auto max-w-screen-xl px-4 py-6 lg:py-8">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center text-center">
                    ...
                    <div className="flex justify-center space-x-5">
                        <a href="https://www.linkedin.com/in/lex-renders/" target="_blank" rel="noopener noreferrer" className="text-gray-100 hover:text-gray-900 dark:hover:text-blue-500">
                        ...
                        <a href="https://github.com/LexRenders" target="_blank" rel="noopener noreferrer" className="text-gray-100 hover:text-gray-900 dark:hover:text-blue-500">
